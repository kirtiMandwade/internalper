         ...
         -->
						...
						<div class="input-group-btn">
							...
							<button class="btn btn-primary" data-toggle="modal"
								...
								style="position: relative; left: -100px; height: 30px">
								<span>Duplicate</span>
							</button>
							<button style="position: relative; left: -95px"
				...
				<table id="listOfProfiles" class="table table-striped" border="1">
					...
					<tr ng-repeat="device in arrWSProfiles">
						...
						<td><a style="cursor: pointer;" data-toggle="modal"
							data-target="#myModal"
							ng-click="edit(device);setDefaultValueForEditChoices()">edit</a></td>
						<td><a style="cursor: pointer;" data-toggle="modal"
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<!-- Company Id:<input class="form-control" type="number"
											...
											<br> <br>
									 -->
										Copy From Company Name:<select class="form-control"
											ng-model="fromCompany" name="selct"
											ng-options="x as x.companyName for x in arrEntityForCompany"></select><br>
										<br> Copy To Company Name:<select class="form-control"
											ng-model="toCompany" name="selct"
											ng-options="x as x.companyName for x in arrEntityForCompany"></select><br>
										<br>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										Profile Code: <input class="form-control" type="text"
											ng-model="dev.wsProfileId.profileCd" name="make" required>
										<br> <br> Company Name: <select class="form-control"
											ng-model="dev.wsProfileId.companyName" name="selct"
											ng-options="x.companyName as x.companyName for x in arrEntityForCompany"></select><br>
										<br>
										...
										ProfileDesc: <input class="form-control" type="text"
											name="color" ng-model="dev.profileDesc" required="required">
												...
												<tr>
													...
													<div class="row">
														<div class="col-sm-4" style="background-color: lavender;">
															Feature Code<select class="form-control"
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										Company Name: <select class="form-control"
											ng-model="devEdit.wsProfileId.companyName" name="selct"
											ng-options="x.companyName as x.companyName for x in arrEntityForCompany"></select><br>
										<br> ProfileDesc: <input class="form-control"
											type="text" name="color" ng-model="devEdit.profileDesc"
											required="required"> <span style="color: Red"
											ng-show="addform.color.$touched && addform.color.$invalid">
											This field is required.</span> <br> <br>
													...
													<div class="row">
														<div class="col-sm-4" style="background-color: lavender;">
															Feature Code<input class="form-control" type="text"
																name="color" ng-model="w.feature.featureCd"
														...
														<div class="col-sm-4"
															style="background-color: lavenderblush;">
															Feature Value <input
																id="choicecheck{{w.profileFeatureId.featureCd}}"
																type="checkbox" ng-true-value="'Y'" ng-false-value="'N'"
																name="check" ng-model="w.featureValue"
																style="display: none">
															<!-- ng-change="checkbox(w) -->
															<input id="choiceedit{{w.profileFeatureId.featureCd}}"
																class="form-control" type="text"
																ng-model="w.featureValue" name="choicevalue"
																disabled="disabled">
															<!-- id="ent1.id" -->
															<select id="selctedit{{w.profileFeatureId.featureCd}}"
														...
														<div class="col-sm-4" style="background-color: lavender;">
															...
															<button type="button" ng-click="deleteNewChoiceForEdit()"
																class="btn btn-info">
																<span class="glyphicon glyphicon-minus"></span>
															</button>
														</div>
											...
											<table>
												...
												<tr>
													<div class="row">
														...
														<div class="col-sm-4"
															style="background-color: lavenderblush;">
															Feature Value <input id="editaddcheck{{choice.id}}"
																type="checkbox" ng-true-value="'Y'" ng-false-value="'N'"
																name="check" ng-model="choice.featureValue"
																style="display: none"> <input
																id="editadd{{choice.id}}" class="form-control"
																type="text" name="choicevalues"
																ng-model="choice.featureValue"> <select
																id="selcteditadd{{choice.id}}" class="form-control"
																ng-model="choice.featureValue" name="selct"
																ng-options="x for x in arrChoicechoice{{choice.id}}"
																style="display: none"></select>
														</div>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									Company Name:<select class="form-control"
										ng-model="dupent.wsProfileId.companyName" name="company"
										ng-options="x.companyName as x.companyName for x in arrEntityForCompany"></select><br>
									<br>Profile Code: <input class="form-control" type="text"
										ng-model="dupent.wsProfileId.profileCd" name="make"
										ng-pattern="/^[A-z]+$/" required><br> <br>
									ProfileDesc: <input class="form-control" type="text"
										name="color" ng-model="dupent.profileDesc" required="required">
									<br> <br>



									<div data-ng-repeat="dup in dupent.profileFeatures"
										style="position: relative;">
										<table>
											<tr>
												...
												<div class="row">
													<div class="col-sm-4" style="background-color: lavender;">
														Feature Code:<input class="form-control" type="text"
															name="color" ng-model="dup.feature.featureCd"
															ng-disabled="buttonCode" required
													...
													<div class="col-sm-4"
														style="background-color: lavenderblush;">
														Feature Value <input
															id="choicecheck{{dup.profileFeatureId.featureCd}}"
															type="checkbox" ng-true-value="'Y'" ng-false-value="'N'"
															name="check" ng-model="dup.featureValue"
															style="display: none">
														<!-- ng-change="checkbox(w) -->
														<input id="choiceedit{{dup.profileFeatureId.featureCd}}"
															class="form-control" type="text"
															ng-model="dup.featureValue" name="choicevalue"
															disabled="disabled">
														<!-- id="ent1.id" -->
														<select id="selctedit{{dup.profileFeatureId.featureCd}}"
															class="form-control" ng-model="dup.featureValue"
															name="selct"
															ng-options="x for x in arrChoicechoice{{dup.profileFeatureId.featureCd}}"
															style="display: none"></select>
