        ...
        <button class="btn btn-primary"  data-toggle="modal" data-target="#addModal" ng-click="addNewChoice();setDefaultValueForChoices()" >
         ...
         -->
						...
						<div class="input-group-btn">
							...
							<button class="btn btn-primary" data-toggle="modal"
								data-target="#addModal" style="position: relative; left: -95px"
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										Company Name:<select class="form-control"
											ng-model="ent.company" name="company"
											ng-options="x as x.companyName for x in arrEntityForCompany"></select><br>
										<br> Product Code:<select class="form-control"
											ng-model="ent.productCd" name="productCd"
											ng-options="x as x.lookUpKey.lookUpValue for x in arrLookUp"></select><br>
										<br>
												...
												<tr>
													...
													<div class="row">
														...
														<div class="col-sm-4"
															...
															Diag Issues Flow:<select id="{{choice.id}}"
																class="form-control" ng-model="choice.diagIissuesFlow"
																ng-options="x.issueCd for x in arrdiagIissuesFlow"></select>

														</div>

														<div class="col-sm-4" style="background-color: lavender;">
															Diag Test:<select id="{{choice.id}}" class="form-control"
																ng-model="choice.diagTest"
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<!-- companyId:<input class="form-control" type="number" name="companyId"
											...
											This field is required.</span> <br> <br> -->
									Company Name:<select class="form-control"
										ng-model="entEdit.company" name="company"
										ng-options="x as x.companyName for x in arrEntityForCompany"></select><br>
									<br>
									...
									Product Cd:<select class="form-control"
										ng-model="entEdit.productCd" name="productCd"
										ng-options="x as x.lookUpKey.lookUpValue for x in arrLookUp"></select><br>
									<br>
								...
								<input
									...
									Severity Code:<select class="form-control"
										ng-model="entEdit.severityCd" name="severityCd"
										ng-options="x as x.lookUpKey.lookUpValue for x in arrSev"></select><br>
									<br> diagIissuesFlow: <select class="form-control"
										ng-model="entEdit.diagIissuesFlow"
										ng-options="x.issueCd for x in arrdiagIissuesFlow"></select><br>
									diagTest: <select class="form-control"
										ng-model="entEdit.diagTest"
										ng-options="x.testCd for x in arrDiagTest"></select> <br>
									<br>
								</div>
						...
						<div class="modal-dialog">
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									Company Name:<select class="form-control"
										ng-model="dupent.company" name="company"
										ng-options="x as x.companyName for x in arrEntityForCompany"></select><br>
									<br> Product Code:<select class="form-control"
										ng-model="dupent.productCd" name="productCd"
										ng-options="x as x.lookUpKey.lookUpValue for x in arrLookUp"></select><br>
									<br>



									<div data-ng-repeat="dupent in choices"
										style="position: relative;">
										<table>
											<tr>
												...
												<div class="row">
													<div class="col-sm-4" style="background-color: lavender;">
														Severity Code:<select class="form-control"
															ng-model="dupent.severityCd" name="severityCd"
															ng-options="x as x.lookUpKey.lookUpValue for x in arrSev"
															ng-selected="dupent.severityCd"></select>
														<span style="color: Red"
															ng-show="addform.severityCd.$touched && addform.severityCd.$invalid">
															This field is required.</span>
													...
													<div class="col-sm-4"
														style="background-color: lavenderblush;">
														Diag Issues Flow:<select id="{{choice.id}}"
															class="form-control" ng-model="dupent.diagIissuesFlow"
															ng-options="x.issueCd for x in arrdiagIissuesFlow"
															ng-selected="dupent.diagIissuesFlow"></select>

													</div>

													<div class="col-sm-4" style="background-color: lavender;">
														Diag Test:<select id="{{choice.id}}" class="form-control"
															ng-model="dupent.diagTest"
															ng-options="x.testCd for x in arrDiagTest"></select>
