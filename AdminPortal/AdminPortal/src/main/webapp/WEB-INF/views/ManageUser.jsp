		...
		<div class="row content">
			<div class="col-sm-3 sidenav">
				...
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a href="../TradeIn/ManageDevice">Device</a></li>
					<li><a href="../TradeIn/ManageGrade">Grade</a></li>
					<li><a href="../TradeIn/ManageDevPrice">Device Price</a></li>
					<li><a href="../TradeIn/ManageProm">Promotions</a></li>
								...
								<div class="modal-body">
									...
									<ul>
										<li ng-repeat=" base in basePrice"
											ng-if="basePrice.length >0">{{ base.companyName }} : {{
											base.basePrice }}</li>
